...
object WasmConfigurationKeysContainer : KeysContainer("org.jetbrains.kotlin.wasm.config", "WasmConfigurationKeys") {
    ...
    val WASM_ENABLE_DRF_ACCELERATION by key<Boolean>("Compile DeepRecursiveFunction literals to stackless state machines with heap frames instead of the coroutine machinery.")
    val WASM_ENABLE_STACKLESS_RECURSION by key<Boolean>("Compile virtual method hierarchies annotated with kotlin.internal.StacklessRecursion to stackless state machines with heap frames.")
}
