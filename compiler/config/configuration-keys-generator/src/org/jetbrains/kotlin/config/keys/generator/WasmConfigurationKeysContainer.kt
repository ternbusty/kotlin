...
object WasmConfigurationKeysContainer : KeysContainer("org.jetbrains.kotlin.wasm.config", "WasmConfigurationKeys") {
    ...
    val WASM_ENABLE_TMC by key<Boolean>("Enable tail-modulo-cons transformation of constructor-wrapped recursion, with selective tail-call emission for the generated helpers.")
}
