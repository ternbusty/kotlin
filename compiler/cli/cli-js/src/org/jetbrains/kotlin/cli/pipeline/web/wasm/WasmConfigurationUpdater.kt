...
object WasmConfigurationUpdater : ConfigurationUpdater<KotlinWasmCompilerArguments>() {
    ...
    private fun fillConfiguration(configuration: CompilerConfiguration, arguments: KotlinWasmCompilerArguments) {
        ...
        configuration.put(WasmConfigurationKeys.WASM_ENABLE_DRF_ACCELERATION, arguments.wasmEnableDrfAcceleration)
        configuration.put(WasmConfigurationKeys.WASM_ENABLE_STACKLESS_RECURSION, arguments.wasmEnableStacklessRecursion)
