...
val actualWasmArguments by compilerArgumentsLevel(CompilerArgumentsLevelNames.wasmArguments) {
    ...
    compilerArgument {
        name = "Xwasm-enable-stackless-recursion"
        description = "Compile virtual method hierarchies annotated with kotlin.internal.StacklessRecursion to stackless state machines with heap frames.".asReleaseDependent()
        valueType = BooleanType.defaultFalse
