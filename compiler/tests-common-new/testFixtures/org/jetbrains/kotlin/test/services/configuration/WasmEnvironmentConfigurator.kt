...
import org.jetbrains.kotlin.test.directives.WasmEnvironmentConfigurationDirectives.ENABLE_TMC
...
open class WasmSecondStageEnvironmentConfigurator(
    ...
    override fun configureCompilerConfiguration(configuration: CompilerConfiguration, module: TestModule) {
        ...
        configuration.put(WasmConfigurationKeys.WASM_ENABLE_TMC, ENABLE_TMC in registeredDirectives)
